    ...
    <NavBar v-if="showNavbar"
      ...
      <template #search>
        <slot name="navbar-search">
          <!-- <AlgoliaSearchBox v-if="theme.algolia"
                            :options="theme.algolia" /> -->
          <!-- 搜索 -->
          <SearchBar :words="keywords" />
        </slot>
      </template>
    </NavBar>
    ...
    <Page v-else>
      <template #top>
        <slot name="page-top-ads">
          <div id="ads-container"
            ...
            <CarbonAds :key="'carbon' + page.relativePath"
      ...
      <template #bottom>
        ...
        <slot name="page-bottom-ads">
          <BuySellAds v-if="theme.carbonAds && theme.carbonAds.custom"
...
const CarbonAds = __CARBON__
  ? defineAsyncComponent(
      () =>
        import("vitepress/dist/client/theme-default/components/CarbonAds.vue")
    )
  : NoopComponent;
const BuySellAds = __BSA__
  ? defineAsyncComponent(
      () =>
        import("vitepress/dist/client/theme-default/components/BuySellAds.vue")
    )
  : NoopComponent;
 ...
 * 全局搜索数据
 */
import keywords from "../dist/keywords.json";
</script>
